...
[_LAYER1] = LAYOUT(
	XXXXXXX,			XXXXXXX,	XXXXXXX,	KC_ASTR,	KC_LCBR,	KC_RCBR, 	KC_PLUS,		KC_PERC, 	KC_LBRC, 	KC_RBRC, 	KC_PIPE, 	XXXXXXX,	XXXXXXX,	XXXXXXX, 
						...
						XXXXXXX,   	KC_CIRC,	KC_UNDS, 	KC_QUES,	KC_EXLM, 	KC_EQL, 		KC_BSLS, 	KC_SCLN, 	KC_COLN, 	KC_SLSH, 	KC_DLR,		XXXXXXX,   
				
						XXXXXXX,   	KC_GRV,		KC_AT,   	KC_LT,		KC_GT,   	KC_MINS, 		KC_TILD, 	KC_LPRN, 	KC_RPRN, 	KC_AMPR, 	KC_HASH,	XXXXXXX, 
